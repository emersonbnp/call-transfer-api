...
let CallController = class CallController {
    ...
    async getCallsInRegion(longitude, latitude, distance, pageSize, pageNumber, response) {
        ...
        const pagination = new paginationfilter_1.Pagination(pageSize, pageNumber);
        const callsInRegion = await this.callService.getCallsInRegion(latitude, longitude, distance);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("1887a2db4cae255d1f3c")
/******/ })();
/******/ 
/******/ }
;